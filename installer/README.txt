...
The mod restores World of Tanks 1.29.1.1 gunshot sounds for recognized standard guns on Tier I-X vehicles. Tier XI and unknown or special firing systems remain unchanged.
The exact mod version is stored in the included VERSION file and is also written to game.log when the mod loads.
...
Мод повертає звуки пострілів World of Tanks 1.29.1.1 для розпізнаних стандартних гармат машин I-X рівнів. Машини XI рівня та невідомі або спеціальні системи стрільби залишаються без змін.
Точна версія мода записана у вкладеному файлі VERSION і також виводиться до game.log під час завантаження мода.
